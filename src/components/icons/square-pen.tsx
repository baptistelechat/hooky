...
// Aucune transition explicite dans l'original (tween par défaut ~0.3s, une fois) --
// boucle continue en badge décoratif : durée et repeat ajoutés pour un tracé calme.
