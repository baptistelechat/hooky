...
// `repeatType: "mirror"` -- l'original bascule une fois normal -> animate au
// survol ; en boucle continue ça ping-pong entre les deux états (couvercle
// qui s'entrouvre et se referme) au lieu de sauter sec au reset.
