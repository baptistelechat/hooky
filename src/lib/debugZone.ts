 ...
 * distinguer les 6 zones de la fenêtre "main" d'un coup d'œil. Ne touche jamais
...
// utile pour "window" quand `flipped` : les autres étiquettes (bubble-zone/slot/avatar) se
...
// aux zones de layout invisibles (window/slot/bubble-zone/avatar) où un fond teinté aide
// à voir l'étendue réelle de la zone.
const ZONE_COLORS = {
  window: "outline-red-500/80 bg-red-500/10",
  slot: "outline-blue-500/80 bg-blue-500/10",
