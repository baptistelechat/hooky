...
// Durée portée de 0.5 à 1.3 + `repeatDelay` -- boucle continue en badge
// décoratif : un shake permanent serait fatigant pour une alerte, une pause
// entre deux secousses garde le signal lisible sans agiter l'oeil en continu.
